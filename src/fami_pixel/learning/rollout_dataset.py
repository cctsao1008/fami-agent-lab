...
def build_rollout_record(
    ...
    *,
    ...
    The record intentionally stores both raw structured observations and a small
    target projection. Future model versions can rebuild normalized features
    without regenerating emulator data.
    """
